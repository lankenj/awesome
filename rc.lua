...
local img_path = "/home/lankenj/img"
local wallpaper_path = img_path .. "/wallpaper/4k/"
local splash_path = img_path .. "/wallpaper/4k/splash"
...
beautiful.init("/home/lankenj/.config/awesome/themes/gobi/theme.lua")
...
clientkeys = gears.table.join(
    awful.key({ modkey, "Control"	}, "Down", 
    	function (c) c:relative_move(0, 50, 0, 0) end, 
	{ description = "move window down", group = "client"}), 
    awful.key({ modkey, "Control"	}, "Up", 
    	function (c) c:relative_move(0, -50, 0, 0) end, 
	{ description = "move window down", group = "client"}), 
    awful.key({ modkey, "Control"	}, "Left", 
    	function (c) c:relative_move(-50, 0, 0, 0) end, 
	{ description = "move window down", group = "client"}), 
